        ...
        <div class="p-6">
            ...
            <div class="mb-5">
                ...
                <select name="visibility" id="visibility"
                    ...
                    <option value="internal" <?php echo ($data['visibility'] == 'internal') ? 'selected' : ''; ?>>Sự kiện nội bộ</option>
                    <option value="public" <?php echo ($data['visibility'] == 'public') ? 'selected' : ''; ?>>Sự kiện công khai</option>
                </select>
            </div>
