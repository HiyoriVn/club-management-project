...
<footer class="bg-gray-100 text-center text-sm text-gray-500 py-4 border-t border-gray-200">
...
<div id="toast-container" class="fixed top-20 right-5 z-50 space-y-3 w-full max-w-sm pointer-events-none">
